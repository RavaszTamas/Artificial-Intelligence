...
class GUI(QMainWindow):
    ...
    def __init__(self, evolutionaryController,hillClimbingController,psoController):
    ...
    def __printPSOResult(self,result):
        ...
        self.mathPlotWidget.canvas.axes.set_title('The best fitness found until that iteration')
    ...
    def __performTests(self):
        ...
        self.__psoController = PSOController(PSORepository,7,1000,100,0.5,1.1,1.5,10)
    ...
    def __doTheTests(self,progress_callback):
        ...
        s = "Average Fitness EA, standard deviation EA = " + "{0:.2f}".format(result[0][1]) +","+"{0:.2f}".format(result[0][2]) + " Average Fitness Hill cimbing, standard deviation Hill climbing = " + "{0:.2f}".format(result[1][1]) +","+"{0:.2f}".format(result[1][2])+" Average Fitness PSO, standard deviation PSO = " + "{0:.2f}".format(result[2][1]) +","+"{0:.2f}".format(result[2][2])
